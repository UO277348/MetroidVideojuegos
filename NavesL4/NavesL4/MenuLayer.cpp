...
void MenuLayer::init() {
	...
	background = new Background("res/fondos/menu_fondo.png", WIDTH * 0.5, HEIGHT * 0.5, game);
	button = new Actor("res/iconos/boton_jugar.png", WIDTH * 0.5, HEIGHT * 0.7, 232, 72, game);
}
